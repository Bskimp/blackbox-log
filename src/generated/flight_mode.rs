...
impl FlightMode {
    const fn from_bit(bit: u32, fw: crate::headers::InternalFirmware) -> Option<Self> {
        ...
        match (bit, fw) {
            ...
            (43u32, Betaflight2026_6 | Betaflight4_5 | Betaflight4_6) => Some(Self::Ready),
            (43u32, Inav5 | Inav6 | Inav7 | Inav8) => Some(Self::Turtle),
            (44u32, Betaflight2026_6 | Betaflight4_5 | Betaflight4_6) => Some(Self::LapTimerReset),
    ...
    const fn to_bit(self, fw: crate::headers::InternalFirmware) -> Option<u32> {
        ...
        match (self, fw) {
            ...
            (Self::Ready, Betaflight2026_6 | Betaflight4_5 | Betaflight4_6) => Some(43u32),
            (Self::Turtle, Inav5 | Inav6 | Inav7 | Inav8) => Some(43u32),
            (Self::LapTimerReset, Betaflight2026_6 | Betaflight4_5 | Betaflight4_6) => Some(44u32),
